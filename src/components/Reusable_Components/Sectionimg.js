...
const Section2 = (props) => {
  return (
    <div className="px-8 py-8 container max-w-full grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 2xl:grid-cols-2 gap-4">
      <div className="order-last lg:order-none col-span-1 md:col-span-1 sm:grid-cols-1 lg:col-span-1 2xl:col-span-1 ">
        <div className="container grid grid-cols-4 gap-2">
          ...
          <li className="list-disc col-span-4 lg:col-span-4 lg:mx-0 text-base md:text-lg lg:text-xl text-secondary font-poppins">
      ...
      <div className="order-first lg:order-none col-span-1 md:col-span-1 sm:grid-cols-1 lg:col-span-2 2xl:col-span-1">
        <div className="box2">
