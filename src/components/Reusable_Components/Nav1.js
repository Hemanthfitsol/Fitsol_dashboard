          ...
          >
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-primary md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-primary dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li>
                ...
                >
                  Content1
                  {/* this is for reverse v-shape icon */}
                  {/* <svg
                  ...
                  >
                    ...
                    <li aria-labelledby="dropdownNavbarLink">
                      <button
                        ...
                        onClick={() => toggleDropdown("doubleDropdown")}
                      >
                        content
                        <svg
                          className="w-2.5 h-2.5 ml-2.5"
                      ...
                      <div
                        id="doubleDropdown"
                        className="z-10 absolute hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 transform translate-x-44"
                      >
                        <ul
