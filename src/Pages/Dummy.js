...
const Home = () => {
  ...
  return (
    <div className="absolute z-2 w-full h-full overflow-hidden bg-primary">
      <Nav3 />
      {!showKyotoHome1 ? (
        <div className=" w-full h-full">
          <div className="absolute inset-0 my-32 mx-auto  overflow-hidden ">
            <video
              ref={videoRef}
              // className="w-full h-full xl:px-[540px] py-[48px] object-cover"
              className="w-96 h-96 px-[12px] lg:px-[12px] mx-auto object-cover overflow-hidden"
              autoPlay
              loop
              muted
            >
          ...
          <div className="relative mx-auto my-32 w-full h-full">
            <svg
